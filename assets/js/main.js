...
window.addEventListener('scroll', () => {
    ...
    glafixLink.addEventListener("click", function(event) {
        ...
        location.reload();
          ...
          const showParagraphBtn = document.getElementById('showParagraphBtn');
          const showImageBtn = document.getElementById('showImageBtn');
          const paragraphToShow = document.getElementById('paragraphToShow');
          const imageToShow = document.getElementById('imageToShow');
  
          // Hide the image on page load (optional, but makes sure the image is hidden by default)
          ...
          showParagraphBtn.addEventListener('click', function () {
              paragraphToShow.style.display = 'block'; // Show the paragraph
              imageToShow.style.display = 'none'; // Hide the image
          });
  
          showImageBtn.addEventListener('click', function () {
              paragraphToShow.style.display = 'none'; // Hide the paragraph
